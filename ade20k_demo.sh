...
srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 4 --max_restarts 1 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" dinov3/eval/segmentation/run.py model.dino_hub=dinov3_vit7b16 config=dinov3/eval/segmentation/configs/config-ade20k-linear-training.yaml datasets.root=/lustre/gale/stf218/scratch/emin/ade20k-dataset output_dir=/lustre/gale/stf218/scratch/emin/dinov3/outputs
