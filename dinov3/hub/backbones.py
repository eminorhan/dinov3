    ...
    **kwargs,
    ...
    if pretrained:
        if type(weights) is Weights and weights not in {Weights.LVD1689M, Weights.SAT493M}:
            ...
            url = _make_dinov3_vit_model_url(patch_size=patch_size, compact_arch_name=compact_arch_name, version=version, weights=weights, hash=hash)
        else:
...
def _make_dinov3_vit_3D(
    ...
    **kwargs,
    ...
    from ..models.vision_transformer import DinoVisionTransformer3D
